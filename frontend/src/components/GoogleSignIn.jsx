...
const GoogleSignIn = ({ className = '', variant = 'default' }) => {
  ...
  const variants = {
    default: "bg-white text-gray-700 border-gray-300 hover:bg-gray-50 hover:border-gray-400 focus:ring-blue-500 shadow-sm",
